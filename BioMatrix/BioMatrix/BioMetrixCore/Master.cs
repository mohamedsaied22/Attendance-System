...
namespace Attendance
{
    public partial class Master : Form
    {
        ...
        private void saveAttLog(ICollection<MachineInfo> logList)
        {
            //MysqlConnect db = new MysqlConnect();
            //int machineNumber = int.Parse(tbxMachineNumber.Text.Trim());
            //Console.WriteLine("MACHINE NUM : "+machineNumber);
            //Console.WriteLine(manipulator.getDeviceSerial(objZkeeper, machineNumber));
            //int machine_id = db.getMachineId(manipulator.getDeviceSerial(objZkeeper, machineNumber));
            ...
            {
                Console.WriteLine(!db.isLogExist(machineInfo.IndRegID, machineInfo.DateTimeRecord, tbxDeviceIP.Text.Trim()));
                if (!db.isLogExist(machineInfo.IndRegID, machineInfo.DateTimeRecord, tbxDeviceIP.Text.Trim()))
                {
                    db.insertLog(machineInfo.IndRegID, machineInfo.DateTimeRecord, tbxDeviceIP.Text.Trim());
